...
export class RepTerapiasComponent implements OnInit {
  items: RepTerapia[] = [];
  filteredItems: RepTerapia[] = [];
  paginatedItems: RepTerapia[] = [];
  ...
  verDetalle(item: RepTerapia) { this.openMenuId = null; }

...
export class GastosComponent implements OnInit {
  ...
  categoryOptions = ['OPERATIVO', 'ADMINISTRATIVO', 'CAMPAÑA', 'OTRO'];

  showModal = false;
  editingItem: Gasto | null = null;
  ...
  saveItem() {
    if (this.editingItem) {
      ...
      if (idx !== -1) this.items[idx] = { ...this.editingItem, ...this.form } as Gasto;
    } else {
      this.items.push({
